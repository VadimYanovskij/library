...
public class DtoConverterImpl implements DtoConverter {
    ...
    public AuthorDto authorToDto(Author author) {
        log.info("Converting author with id = {} to com.senla.training.library.dto", author.getId());
    ...
    public BookDto bookToDto(Book book) {
        log.info("Converting book with id = {} to com.senla.training.library.dto", book.getId());
    ...
    public BorrowDto borrowToDto(Borrow borrow) {
        log.info("Converting borrow with id = {} to com.senla.training.library.dto", borrow.getId());
    ...
    public CategoryDto categoryToDto(Category category) {
        log.info("Converting category with id = {} to com.senla.training.library.dto", category.getId());
